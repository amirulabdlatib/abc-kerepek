<template>
    <div class="bg-white rounded-2xl p-6 shadow-sm sticky top-6">
        ...
        <NuxtLink to="/bayaran" class="w-full bg-primary text-white py-3 rounded-full hover:bg-primary-dark transition-colors duration-200 font-medium text-sm flex items-center justify-center gap-2 group">
